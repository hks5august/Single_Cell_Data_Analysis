...
jpeg('UMAP_plot_EB_EB_2D_comb.jpg', units="in", width=10, height=8, res=300)
plot_grid(p1, p2)
...
Integ_data_clus1 <- RenameIdents(Integ_data_clus, `0` = "cell_type1", `1` = "cell_type2", `2` = "cell_type3", 
                                 `3` = "cell_type4", `4` = "cell_type5", `5` = "cell_type6", `6` = "cell_type7", `7` = "cell_type8", `8` = "cell_type9", `9` = "cell_type10", `10` = "cell_type11")
...
jpeg('UMAP_plot_EB_vs_2D_overlapping.jpg', units="in", width=10, height=8, res=300)
...
write.table(group_dist,file="EB_ctrl_vs_EB_2D_cell_dis.txt", sep='\t',  quote = F,row.names = FALSE)
...
#Write results into a file
write.table(group_dist,file="EB_ctrl_vs_EB_2D_cell_dis_proporton.txt", sep='\t',  quote = F,row.names = FALSE)
